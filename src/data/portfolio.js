...
export const projects = {
  'Optician Shop Management.app': {
    ...
    icon: '🏢',
    description: 'A complete multi-shop management solution for optical retail businesses, supporting multiple independent businesses, branches, staff, and inventory.',
    ...
    details: {
      highlights: [
        { title: "🏢 Multi-Shop Architecture", description: "Single installation manages multiple businesses with complete data isolation" },
        { title: "👓 Optical-Specific Workflows", description: "Handles the unique 'Deposit → Lab Work → Pickup' sales cycle" },
        { title: "📋 Prescription Management", description: "Complete spectacle and contact lens prescription tracking with expiry alerts" }
      ],
      features: [
        { category: "👥 Customer Management", items: ["Complete customer profiles", "Family linking system", "Prescription expiry alerts"] },
        { category: "💳 Point of Sale (POS)", items: ["Touch-optimized interface", "Split payments", "Multiple payment methods"] }
      ]
    }
  },
  'Headless-PWA-store.app': {
    ...
    icon: '🛒',
    description: 'A high-performance headless e-commerce store with full PWA support, multi-theme capability, and real-time push notifications.',
    ...
    details: {
      highlights: [
        { title: "🛒 Full E-Commerce", description: "Complete shopping experience with cart, wishlist, and order tracking." },
        { title: "📱 PWA Ready", description: "Installable on any device with offline support for browsing products." },
        { title: "🔔 Push Notifications", description: "Real-time order status updates powered by Firebase Cloud Messaging." }
      ],
      features: [
        { category: "🛍️ Shopping Experience", items: ["Advanced Cart & Wishlist", "Secure checkout flow", "Real-time tracking"] },
        { category: "⚙️ Core Capabilities", items: ["Offline functionality", "Auto-detect Dark Mode", "Full Authentication"] }
      ]
    }
  },
  'Zombie Subscriptions.app': {
    ...
    icon: '🧟',
    description: 'A beautiful, modern subscription tracker app. Manage your recurring payments with ease and never miss a renewal.',
    ...
    details: {
      highlights: [
        { title: "📊 Spending Dashboard", description: "Track total monthly spending and upcoming renewal costs at a glance." },
        { title: "🔔 Renewal Reminders", description: "Automated push notifications to ensure you never miss a payment." },
        { title: "🌍 Multi-language", description: "Full support for English, French, and Arabic interfaces." }
      ],
      features: [
        { category: "✨ App Features", items: ["Beautiful UI with smooth animations", "Dark/Light Mode switching", "Supabase Auth"] }
      ]
    }
  },
  'Complaints App.app': {
    ...
    icon: '⚖️',
    description: 'A robust complaint management system for union members, featuring multi-language support, real-time notifications, and automated workflows.',
    ...
    details: {
      highlights: [
        { title: "🌍 Multi-Language Support", description: "Complete support for Arabic and French with RTL UI." },
        { title: "🔒 CNDP Compliance", description: "Strict data privacy features and automated consent tracking." },
        { title: "📱 Responsive Design", description: "Optimized for all devices including mobile-friendly data tables." }
      ],
      features: [
        { category: "🛡️ Security", items: ["Row Level Security", "Two-Factor Auth", "Audit Logging"] },
        { category: "📊 Management", items: ["Admin Dashboard", "Export to CSV/PDF", "Real-time analytics"] }
      ]
    }
  },
};
...
export const cvContent = {
  ...
  contact: 'omouzgui@gmail.com • Morocco • github.com/mouzgui • linkedin.com/in/mouzgui-oussama',
  summary: "I transform complex ideas into scalable, high-performance applications. My core expertise lies in the Next.js, React, and Node.js ecosystem, complemented by a solid foundation in Laravel, Python, and TypeScript. I'm dedicated to clean code, smooth animations, and exceptional user experiences.",
  experience: [
    {
      company: 'Freelance',
  ...
  skills: ['Next.js', 'React.js', 'Node.js', 'Tailwind CSS', 'TypeScript', 'Laravel', 'Supabase', 'Firebase'],
  education: {
